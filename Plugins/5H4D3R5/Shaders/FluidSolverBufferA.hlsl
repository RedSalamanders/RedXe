...
// HLSL port for RedXe (Buffer A, a feedback pass that reads its own previous frame on iChannel0 with repeat wrap).
...
float simplex3d(vec3 p) {
     ...
     vec4 w = vec4(0.0, 0.0, 0.0, 0.0), d = vec4(0.0, 0.0, 0.0, 0.0);
