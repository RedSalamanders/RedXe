...
[void]$builder.AppendLine()
[void]$builder.AppendLine('inline constexpr std::uint32_t kMatrixRainGlyphAtlasSize = 128;')
[void]$builder.AppendLine('inline constexpr std::uint32_t kMatrixRainGlyphCount = 64;')
