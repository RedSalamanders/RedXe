...
Smallest useful tile is 160×180 DIPs; every live target is at least 48×48 DIPs. Device icons stay 32 DIP inside the cards. Volume sliders fill their row with a thin track and a small accent thumb; the whole row stays the 48 DIP hit target. Displayed mute and level state changes only after Windows confirms the action. Failure stays visible; it is never drawn as a successful mute or profile switch.
