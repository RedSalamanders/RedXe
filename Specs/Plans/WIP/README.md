...
| [`LogiconPlugin_2026-09-16.md`](LogiconPlugin_2026-09-16.md) | `ACTIVE` | `Specs/Plugins/Plugins_API.md`, `Specs/Core/Core_PerformanceAndResources.md`, `Specs/Core/Core_Settings.md`, `Specs/UI/UI_Dashboard.md`, and new `Specs/Plugins/Plugins_Logicon.md` | Logitech MX Creative Console: service plugin without a tile (Release), host-owned device lane, host action queue, `services` settings root, Debug-only monitor tile, dialpad after capture. |
...
| [`RFC_Plugins_WeatherProvidersAndRegionalAlerts.md`](RFC_Plugins_WeatherProvidersAndRegionalAlerts.md) | `DECISION` | `Specs/Plugins/Plugins_Weather.md`, `Specs/Plugins/Plugins_API.md`, and `Specs/Core/Core_Settings.md` | How to wire further forecast providers and regional early-warning providers (Canada, Japan, Hong Kong, Australia, Brazil, WMO Alert Hub) into the weather widget under the no-key policy; candidates, terms, and the CAP-reader, routing, attribution, and transport decisions. |
